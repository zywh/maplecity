...
'#Special_content'=>array('uploadJson'=> $this->createUrl('upload')))));?></td>
  </tr>
  <tr>
  ...
  <tr>
    <td ><select name="Special[catalog_id]" id="Special_catalog_id" onchange="changeCatalog(this)" class='validate[required]'>
        <option value>==所属类别==</option>
        <?php foreach((array)Bagecms::getList('Catalog', '_catalog', array('where'=>'parent_id<>0')) as $catalog):?>
  ...
  <tr>
    <td class="tb_title">状态/排序:</td>
  </tr>
  <tr >
    <td class=" rowform">状态：<?php echo $form->dropDownList($model,'status_is',array('Y'=>'显示', 'N'=>'隐藏')); ?>&nbsp;&nbsp;&nbsp;&nbsp;
      排序：<?php echo $form->textField($model,'view_count',array('size'=>8,'maxlength'=>8)); ?></td>
  </tr>
  <tr>
