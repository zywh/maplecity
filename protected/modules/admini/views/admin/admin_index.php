...
<table class="content_list">
  <form method="post" action="" name="cpform" >
    ...
    <tr class="tb_list">
      ...
      <td>
        <?php if($row->id != 1){ ?>
        <a href="<?php echo  $this->createUrl('update',array('id'=>$row->id))?>"><img src="<?php echo $this->_baseUrl?>/static/admin/images/update.png" align="absmiddle" /></a>&nbsp;&nbsp;<a href="<?php echo  $this->createUrl('batch',array('command'=>'adminDelete', 'id'=>$row->id))?>" class="confirmSubmit"><img src="<?php echo $this->_baseUrl?>/static/admin/images/delete.png" align="absmiddle" /></a>
        <?php }else{echo '超级管理员';} ?>
      </td>
    </tr>
    <?php endforeach;?>
