...
class Special extends XBaseModel
{
	...
	{
		return array(
			array('title, title_alias, catalog_id', 'required'),
			...
			array('id, title, title_alias, intro, content, attach_thumb, attach_file, seo_title, seo_keywords, seo_description, template, status_is, sort_order, view_count, create_time, catalog_id', 'safe', 'on'=>'search'),
		);
	}
